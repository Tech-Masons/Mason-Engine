...
namespace Graphics
{
	...
	public:
		...
		virtual uint CreateShaderPipeline(const std::string& vsData, const std::string& psData, std::vector<InputElement> layout, TopologyType topology, const int num_cbvs, uint* cbv_sizes);
